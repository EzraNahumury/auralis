...
const ITEMS: Item[] = [
  { label: "Portaldot", icon: Hexagon },
  { label: "ink!", icon: PenLine },
  { label: "Substrate", icon: Boxes },
  { label: "POT gas", icon: Fuel },
  { label: "Anthropic Claude", icon: BrainCircuit },
  { label: "IPFS", icon: Database },
  { label: "LangChain", icon: Workflow },
  { label: "Next.js 16", icon: Layers },
  { label: "GSAP", icon: Wand2 },
  { label: "Lenis", icon: Waves },
];
