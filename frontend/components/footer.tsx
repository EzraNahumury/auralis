...
const navLeft = [
  ...
  { label: "TELEGRAM", href: "https://t.me/portaldot" },
  { label: "DISCORD", href: "https://discord.gg/portaldot" },
  { label: "MIRROR", href: "https://portaldot-dev.readthedocs.io/" },
];

const navRight = [
  { label: "DOCS", href: "https://portaldot-dev.readthedocs.io/" },
    ...
    <footer className="relative isolate overflow-hidden bg-bg pt-20 sm:pt-24">
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10">
        ...
        <div className="relative mt-6 flex flex-col items-start justify-between gap-2 border-t border-border/60 py-6 text-xs text-fg-dim sm:flex-row sm:items-center">
          ...
          >
            © 2026 Auralis. MIT-licensed core contracts.
          </p>
          <p
            style={{
              fontFamily:
          ...
          >
            POT-gas only. ink! 5.x. substrate-interface.
          </p>
        </div>
      </div>
    </footer>
